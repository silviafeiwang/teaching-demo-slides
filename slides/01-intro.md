...
::: {.notes}
We often think of computation as abstract — code, algorithms, memory.
...
But it cannot see, hear, or move by itself.

It needs peripheral devices.

Sensors bring information in.
Actuators push actions out.
